...
import { registerAccount,loginUser, sendOTP, checkOTP, refressToken, logoutUser, loginAdmin } from '../controllers/authControllers.js'; 
...
router.post(API_PATH.LOGIN_ADMIN,loginAdmin)
